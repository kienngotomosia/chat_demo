...
import 'package:flutter_chat_demo/models/chat_agrument_model.dart';
import 'package:flutter_chat_demo/models/models.dart';
import 'package:flutter_chat_demo/pages/auth/login_screen.dart';
import 'package:flutter_chat_demo/pages/video_call/video_call_screen.dart';
...
class ChatPageState extends State<ChatPage> {
  ...
  String _authServerKey =
      'AAAAToKYWKY:APA91bGkeiC9gCOlX1e_8ZxojHDkWUN1id38c4WNaWAmIVXbOiwVyd1AHzcjb51bDLOoLdHMCMBUDneFi69xBfTZqTZcr6J8dFyawha1DiNzGPJGf4FiktLOAp_GhhNjCSwKhEh41vYo';
    ...
    if (content.trim().isNotEmpty) {
      ...
      if (listScrollController.hasClients) {
        ...
        sendNotification(
            ...
            notificationToken: widget.arguments.pushToken);
      }
    } else {
